...
dotnet pack -c Release -o $OUTPUT_PATH/Integration.PriorAuth.Infra.Base.Package -p:PackageVersion=1.1."$PATCH_NUMBER" -p:PackageID="Integration.PriorAuth.Infra.Base"
popd